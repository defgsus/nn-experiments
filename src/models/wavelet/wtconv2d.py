...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5, stride=1, bias=True, wt_levels=1, wt_type='db1'):
        ...
        self.wt_filter, self.iwt_filter = util.create_wavelet_filter(wt_type, in_channels, in_channels, torch.float)
    ...
    def forward(self, x):
        ...
        for i in range(self.wt_levels):
            ...
            curr_x = util.wavelet_transform(curr_x_ll, self.wt_filter)
            curr_x_ll = curr_x[:,:,0,:,:]
        ...
        for i in range(self.wt_levels-1, -1, -1):
            ...
            next_x_ll = util.inverse_wavelet_transform(curr_x, self.iwt_filter)
