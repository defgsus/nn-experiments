...
| [zip1M](#f=zip1M-tsne2)             | [tabularisai/Zip-1](https://huggingface.co/tabularisai/Zip-1)                                                             | It's **very** small, which makes a difference if you need to embed a 100 million texts. Judge it's quality yourself. |  
...
In the Interest Similarity Search above, the similarity is calculated by calculating the distance of the resulting 2d positions. The closest interests are also displayed in a (pretty ugly) 2d map. 
